...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// The nested function above can access the internal variable because it is called inside the nestedFunction.
...
const displayName = zooAnimals.forEach(function (animalNames) {
  displayName.push(
    `Name: ${animalNames.animal_name}, Scientific: ${animalNames.scientific_name}.`
  );
});
// const displayName = [];
